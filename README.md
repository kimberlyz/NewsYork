...
NewsYork is an android app that allows a user to search for articles on web using simple filters. The app utilizes [New York Times Search API](http://developer.nytimes.com/docs/read/article_search_api_v2).
...
<img src='http://i.imgur.com/qVCM7ev.gif?1' title='' width='' alt='Video Walkthrough' /> 
<img src='http://i.imgur.com/QbLSrOA.gif?1' title='' width='' alt='Video Walkthrough' />
